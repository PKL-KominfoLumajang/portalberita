...
<head>
    <meta charset="utf-8" />
    <title>Majalah Remang-Remang</title>
    ...
    <form class="form-signin" method="post">
        ...
        <div class="form-group">
            <div class="text-center text-header">
                <img src="<?php echo PATH; ?>resources/images/login.png" style="width:75px;" alt="logo">
        ...
        <div class="form-group">
            ...
            <input type="text" id="input-username" name="username" class="form-control" placeholder="ex : kominfo" required autofocus>
        </div>
        <div class="form-group">
